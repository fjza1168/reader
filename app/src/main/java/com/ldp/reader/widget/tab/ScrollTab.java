...
public class ScrollTab extends HorizontalScrollView implements View.OnClickListener, ViewPager.OnPageChangeListener {
    ...
    private Paint mPaint,mDotPaint;
    ...
    private void initTypedArray(Context context, AttributeSet attrs) {
        ...
        mPadding = typedArray.getDimension(R.styleable.lib_pub_ScrollTab_lib_pub_stab_padding, ScreenUtils.dpToPx(12));
        ...
        mIndicatorWidth = typedArray.getDimension(R.styleable.lib_pub_ScrollTab_lib_pub_stab_indicatorWidth, ScreenUtils.dpToPx(30));
        mIndicatorWeight = typedArray.getDimension(R.styleable.lib_pub_ScrollTab_lib_pub_stab_indicatorWeight, ScreenUtils.dpToPx(1));
        mIndicatorRadius = typedArray.getDimension(R.styleable.lib_pub_ScrollTab_lib_pub_stab_indicatorRadius, ScreenUtils.dpToPx(1));
        mIndicatorPadding = typedArray.getDimension(R.styleable.lib_pub_ScrollTab_lib_pub_stab_indicatorPadding, ScreenUtils.dpToPx(5));
        typedArray.recycle();
    }
    ...
    private void init(Context context) {
        ...
        LinearGradient linearGradient =new LinearGradient(0,0,200,0, mIndicatorColor,Color.YELLOW, Shader.TileMode.MIRROR);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mIndicatorType == TYPE_INDICATOR_TREND) {
            left = mTabs.get(mPosition).getLeft() + mIndicatorPadding;
            right = mTabs.get(mPosition).getRight() - mIndicatorPadding;
            float oriLeft = left;
            float dotRadius = mIndicatorWeight / 2;
            ...
            left = mTabs.get(mPosition).getLeft();
            right = mTabs.get(mPosition).getRight();
