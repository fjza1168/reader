...
import com.ldp.reader.ui.fragment.DiscCommentFragment;
import com.ldp.reader.ui.fragment.DiscHelpsFragment;
import com.ldp.reader.ui.fragment.DiscReviewFragment;
import com.ldp.reader.utils.Constant;
import com.ldp.reader.widget.SelectorView;
import com.ldp.reader.model.flag.BookSelection;
...
public class BookDiscussionActivity extends BaseActivity implements SelectorView.OnItemSelectedListener {
    ...
    private void setUpSelectorView(int type){
        if (type == TYPE_FIRST){
            mSvSelector.setSelectData(BookSelection.DISTILLATE.getTypeParams(), BookSelection.SORT_TYPE.getTypeParams());
        }
        else {
            mSvSelector.setSelectData(BookSelection.DISTILLATE.getTypeParams(),
                    BookSelection.BOOK_TYPE.getTypeParams(), BookSelection.SORT_TYPE.getTypeParams());
        }
    }
